...
@rem ##########################################################################
@rem
@rem  griffon-fingerprint startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute griffon-fingerprint
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" io.github.aretche.griffonFingerprint.Launcher %CMD_LINE_ARGS%
